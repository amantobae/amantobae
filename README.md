...
On the lower-level side, I work with C++ and Raylib, developing games and desktop applications. I enjoy the control that comes with systems programming — writing game loops, rendering pipelines, and building things from scratch.
...
[![](https://visitcount.itsvg.in/api?id=amantobae&icon=0&color=0)](https://visitcount.itsvg.in)
